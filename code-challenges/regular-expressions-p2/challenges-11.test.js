...
const validateEmail = (email) => {
  // Solution code here...
 const testOne = /^\w+@|^\w+\.|w+@/g;
 const testTwo = /@\w+\.(net|org|com)$/g;
 return testOne.test(email) && testTwo.test(email);
...
// huge thanks to Jack as always for walking me through these!
